...
public class CTRBodeguero {
    ...
    private PnlMenuBodeguero pnlMenu;
    ...
    public void iniciar(){ 
        ...
        pnlMenu.getBtnFacturas().addMouseListener(new CTRBtns(pnlMenu.getBtnFacturas()));
        pnlMenu.getBtnProductos().addMouseListener(new CTRBtns(pnlMenu.getBtnProductos())); 
    ...
    public void productos(){ 
        ...
        pnlProductos.getBtnEliminar().addMouseListener(new CTRBtns(pnlProductos.getBtnEliminar())); 
        pnlProductos.getBtnIngresar().addMouseListener(new CTRBtns(pnlProductos.getBtnIngresar())); 
        pnlProductos.getBtnModificar().addMouseListener(new CTRBtns(pnlProductos.getBtnModificar())); 
    }
    ...
    public void facturas(){
        ...
        pnlFacturas.getBtnInformacion().addMouseListener(new CTRBtns(pnlFacturas.getBtnInformacion()));
        pnlFacturas.getBtnIngresar().addMouseListener(new CTRBtns(pnlFacturas.getBtnIngresar())); 
        pnlFacturas.getBtnModificar().addMouseListener(new CTRBtns(pnlFacturas.getBtnModificar())); 
